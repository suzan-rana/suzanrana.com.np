...
const Projects = () => {
  return (
    <div className="py-12 max-w-[900px] w-[90%] mx-auto my-20 dark:bg-transparent  ">
      ...
      <p className="md:text-lg text-gray-700 leading-8 py-4 text-center md:w-[65%] mx-auto dark:text-black">
      ...
      <div className="flex flex-col lg:justify-between my-12 flex-wrap gap-12 md:flex-row  ">
        <div className="w-[100%] shadow-md rounded-xl overflow-hidden px-6 py-6 lg:w-[45%] bg-white bg-opacity-50 backdrop-filter backdrop-blur-lg">
        ...
        <div className="shadow-md rounded-xl px-6 py-6 lg:w-[45%] bg-white bg-opacity-50 backdrop-filter backdrop-blur-lg">
          ...
          <p className="py-6 md:text-lg text-gray-700">
            This project was made using TailwindCSS. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Quam corrupti dolorum consequuntur
            modi velit. Magnam?
          </p>
