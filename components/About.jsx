...
const About = () => {
  return (
    <div className="mt-12 p-4 mx-auto max-w-[900px] w-[90%] pb-16">
      ...
      <p className="text-xl py-6 leading-8 ">
        ...
        help people and  grow business, it makes my heart warm and glad and the
        sense of satisfaction of that particular moment keeps me moving forward.
      </p>
      <h3 className="text-center text-xl  font-clashDisplay my-8 ">If you wish to say Hello, or talk about anything, I am here for you.</h3>
